        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DES_EMPRESA = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    COD_PARAMETRO = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DES_PARAMETRO = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    COD_TIPO_PARAMETRO = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DTH_REGISTRO = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BOL_ACTIVO = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    COD_TIPO_FUNCIONARIO = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DES_TIPO_FUNCIONARIO = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ID_EMPRESA = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    COD_FILIAL = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DES_FILIAL = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BOL_ACTIVO = table.Column<bool>(type: "bit", nullable: false),
                    DTH_REGISTRO = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ID_EMPRESA = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    COD_GRUPO_PRODUTO = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DES_GRUPO_PRODUTO = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ID_TIPO_FUNCIONARIO = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    COD_FUNCIONARIO = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    COD_MESA = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    COD_ESTADO = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DTH_REGISTRO = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BOL_ATIVO = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ID_FILIAL = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ID_EMPRESA = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ID_PARAMETRO = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ID_EMPRESA = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ID_GRUPO_PRODUTO = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ID_FILIAL = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ID_FUNCIONARIO = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    DTH_REGISTRO = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ID_COMANDA = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ID_PRODUTO_FILIAL = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    NUM_QUANTIDADE = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DTH_REGISTRO = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
